...
{	$requser = $bdd->prepare('SELECT * FROM utilisateur WHERE id = ?');
	...
	$Marv = $bdd->prepare('SELECT * FROM comics WHERE id_Categorie = 1');
	$Marv->execute(array());
?>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="content-area">
		<div class="wrapper">
			<h2>E-Comics</h2>
			<article>
 <p>Ici vous vous  trouverz dams la secttion marvel</p>
 <p>Vous trouvererais des classics du monde des comics ainsi que des histoires plus courantes et plus recentes</p>
 <p>Si vous commencez dans le monde des comics Marvel : Voici quelques suggestions
 Premierement si vous ne connaissait rien vous pouvais commentcer par les anthologie JE SUIS 
Il existe aussi des histoires emblematiques comme l histoire de civil wars ou aussi l histoire de spiderverses ou l evenement orginal sinss</p></p></article>
  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <br>
        <a href="comics.php" class="btn btn-primary">Voir la fiche complete</a>
      </div>
    </div>           
		<?php } ?>
